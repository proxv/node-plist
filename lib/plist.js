;(function (exports, DOMParser, xmlbuilder) {
	...
	var inNode = typeof module === 'undefined' ? false : true
 	  , utf8_to_b64
 	  , b64_to_utf8;
	...
	function parsePlistXML(node) {
		...
		if (node.nodeName === 'plist') {
			...
			var strippedRes = res.replace(/\s/g,'');
			if (strippedRes && !base64Matcher.test(strippedRes)) {
...
})(typeof exports === 'undefined' ? plist = {} : exports, typeof module !== 'undefined' ? require('xmldom').DOMParser : null, typeof module !== 'undefined' ? require('xmlbuilder') : xmlbuilder)
